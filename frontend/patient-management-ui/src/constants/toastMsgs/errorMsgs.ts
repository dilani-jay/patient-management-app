...
export const PATIENT_CREATE_ERROR = 'Failed to create patient'
export const PATIENT_UPDATE_ERROR = 'Failed to update patient'
export const PATIENT_DELETE_ERROR = 'Failed to delete patient'